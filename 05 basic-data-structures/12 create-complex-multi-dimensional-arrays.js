/*
  ...
  URL:    https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/basic-data-structures/create-complex-multi-dimensional-arrays
*/
...
/* Exercise*/
  ...
  //NOTE 
  //[x] myNestedArray should contain only numbers, booleans, and strings as data elements
  //[x] myNestedArray should have exactly 5 levels of depth
  //[x] myNestedArray should contain exactly one occurrence of the string deep on an array nested 3 levels deep
  //[x] myNestedArray should contain exactly one occurrence of the string deeper on an array nested 4 levels deep
  //[x] myNestedArray should contain exactly one occurrence of the string deepest on an array nested 5 levels deep
